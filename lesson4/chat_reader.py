...
from chat_common import get_logged_message, chat_connector, get_argparser, _non_empty_printable, run_client, _port


async def client_reader(filename, chat_connector):
...
if __name__ == '__main__':
    ...
    chat_handler = partial(client_reader, options.history, connector)

    logging.info(f"Chat reader is starting with options: {options}")
